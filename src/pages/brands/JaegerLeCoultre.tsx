        ...
        <div className="container px-4">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              <span className="text-[#D4AF37]">Jaeger-LeCoultre</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
              The Grande Maison of the Vallée de Joux. Masters of ultra-thin movements 
              and the iconic Reverso since 1833.
            </p>
          </motion.div>
          ...
          <div className="glass rounded-xl p-8 md:p-12 text-center">
            ...
            <p className="text-muted-foreground">
              Our Jaeger-LeCoultre collection showcase is currently being prepared. 
...
export default JaegerLeCoultre;
