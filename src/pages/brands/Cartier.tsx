        ...
        <div className="container px-4">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              <span className="text-[#D4AF37]">Cartier</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
              The jeweler of kings and king of jewelers. Cartier's iconic timepieces 
              combine exceptional craftsmanship with timeless French elegance.
            </p>
          </motion.div>
          ...
          <div className="glass rounded-xl p-8 md:p-12 text-center">
            ...
            <p className="text-muted-foreground">
              Our Cartier collection showcase is currently being prepared. 
