        ...
        <div className="container px-4">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              <span className="text-[#D4AF37]">Richard Mille</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
              Racing machines on the wrist. Revolutionary materials and cutting-edge technology 
              define Richard Mille's approach to haute horlogerie since 2001.
            </p>
          </motion.div>
          ...
          <div className="glass rounded-xl p-8 md:p-12 text-center">
            ...
            <p className="text-muted-foreground">
              Our Richard Mille collection showcase is currently being prepared. 
